...
$upload_dir = PRJ_REF.'/files/'; // path from base_url to base of upload folder (with start and final /)
...
$ext_misc = array('zip', 'rar','gz','tar','iso','dmg', 'pdf'); //Archives
...
$hidden_files = array('config.php', '.htaccess');
