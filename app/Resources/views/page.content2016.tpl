...
<body>
        ...
        <div class="golden-bg">
            <div class="container">
                <div class="content">
                    <div class="attention" id="attention-rus">
                        В случае успешной регистрации Вы (УБИТЬ СЛОВО ТАКЖЕ) получите подтверждение от представителя холдинга АНКОР на указанный адрес электронной почты или номер телефона.<br>
                    ...
                    <div class="attention" id="attention-eng">In case of positive regostration you'll get confirmation from the ANCOR representative via e-mail or by phone.<br>
