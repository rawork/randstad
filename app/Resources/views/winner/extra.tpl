...
<div class="winner-main extra clearfix">
    <div class="goblet goblet-extra"><img src="{$theme_ref}/public2016/img/prize3_new.png"></div>
    <div class="winner">
        <div class="title"><span>{$winner.nomination}</span> {$winner.industry}&nbsp;— <strong>{$winner.name}</strong></div>
        <ul class="photo clearfix">
            <li class="certificate">
                <div class="goblet-xs goblet-xs-extra"><img src="{$theme_ref}/public2016/img/prize3_new.png"></div>
